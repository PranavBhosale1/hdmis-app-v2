        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="government" className="space-y-4 mt-6">
            <div className="space-y-4">
              ...
              <div>
                <Label htmlFor="govt-nhi">NHI ID</Label>
                <Input id="govt-nhi" placeholder="NHI ID" />
              </div>
              
              <div>
                <Label htmlFor="govt-email">Email ID</Label>
                <Input id="govt-email" type="email" placeholder="EMAIL ID" />
              </div>
              ...
              <div className="text-center">
                ...
                <Button variant="link" className="text-primary p-0 h-auto">LOGIN</Button>
              </div>
              
              <Button className="w-full bg-primary hover:bg-hdims-teal-dark">
                Register
              </Button>
            </div>
          </TabsContent>
